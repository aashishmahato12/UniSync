...
export type DocumentItem = { id: string; name: string; category: string; date: string; size: string; type: string; mimeType: string; storagePath: string; gmailMessageId: string; emailSubject: string; sender: string; noticeSummary?: string; extractedText?: string; extractionStatus?: 'Pending' | 'Ready' | 'No text'; sourceUrl: string }
