...
>
        ...
        <nav className={`mobile-bottom-nav${mobileNavOpen ? ' liquid-open' : ''}`} aria-label="Primary navigation">
          ...
          <div className="mobile-liquid-slot">
            <Liquid className="mobile-liquid-menu" blur={14} contrast={22} fill="var(--mobile-liquid-surface)" shadow="inset 0 1px 0 rgba(255,255,255,.35), 0 9px 22px rgba(31,48,68,.16)" filterPadding={40} waviness={0.55}>
